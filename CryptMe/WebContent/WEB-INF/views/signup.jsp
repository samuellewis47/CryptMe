...
<form:form method="POST" action="./signupProcess" modelAttribute="signupForm">
<div class="section-container">
	<div class="container">
		<div class="row">
			<div class="col-md-4"><h4>Sign Up</h4></div>
		</div>
		<div class="row">
			<div class="col-md-4">
        ...
        <div class="row">
			...
			<div class="col-md-2">
				...
				<form:input type="password" path="plainPassword"></form:input>
			</div>	
			<div class="col-md-2">
        ...
        <div class="row">
        	<br>                
			<div class="col-md-2"><button type="submit" class="btn btn-primary btn-sm">Sign Up</button></div>
        </div>
	</div>
</div>
</form:form>
