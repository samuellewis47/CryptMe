...
<form:form method="POST" action="./loginProcess" modelAttribute="loginForm">
<div class="section-container">
	<div class="container">
        ...
        <div class="row">
        	<br>                
			<div class="col-md-2"><button type="submit" class="btn btn-primary btn-sm">Login</button></div>
        </div>
	</div>
</div>
</form:form>
